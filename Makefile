...
coverage:; forge coverage --ir-minimum --no-match-test invariant --no-match-contract Temp  --ffi --skip .s.sol
coverageReport:; forge coverage --ir-minimum --no-match-test invariant --no-match-contract Temp --ffi --skip .s.sol --report debug > report/coverage.txt
...
buildAll:; forge build --via-ir --optimize